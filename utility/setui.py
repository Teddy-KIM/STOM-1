...
def SetUI(self):
    ...
    self.ssb_pushButton_05 = setPushbutton('고저평균대비등락율', box=self.ss_tab, click=self.ButtonClicked_11)
    self.ssb_pushButton_06 = setPushbutton('체결강도차이', box=self.ss_tab, click=self.ButtonClicked_12)
    self.ssb_pushButton_07 = setPushbutton('초당거래대금차이', box=self.ss_tab, click=self.ButtonClicked_13)
    self.ssb_pushButton_08 = setPushbutton('VI해제시간비교', box=self.ss_tab, click=self.ButtonClicked_14)
    self.ssb_pushButton_09 = setPushbutton('호가총잔량비교', box=self.ss_tab, click=self.ButtonClicked_15)
    self.ssb_pushButton_10 = setPushbutton('1호가잔량비교', box=self.ss_tab, click=self.ButtonClicked_16)
    self.ssb_pushButton_11 = setPushbutton('', box=self.ss_tab, click=self.ButtonClicked_17)
    self.ssb_pushButton_12 = setPushbutton('', box=self.ss_tab, click=self.ButtonClicked_18)
    self.ssb_pushButton_13 = setPushbutton('', box=self.ss_tab, click=self.ButtonClicked_19)
    self.ssb_pushButton_14 = setPushbutton('', box=self.ss_tab, click=self.ButtonClicked_20)
    ...
    self.sss_pushButton_05 = setPushbutton('보유시간기준', box=self.ss_tab, click=self.ButtonClicked_29)
    self.sss_pushButton_06 = setPushbutton('손절라인설정', box=self.ss_tab, click=self.ButtonClicked_30)
    self.sss_pushButton_07 = setPushbutton('익절라인설정', box=self.ss_tab, click=self.ButtonClicked_31)
    self.sss_pushButton_08 = setPushbutton('체결강도차이', box=self.ss_tab, click=self.ButtonClicked_32)
    self.sss_pushButton_09 = setPushbutton('호가총잔량비교', box=self.ss_tab, click=self.ButtonClicked_33)
    self.sss_pushButton_10 = setPushbutton('VI직전매도', box=self.ss_tab, click=self.ButtonClicked_34)
    self.sss_pushButton_11 = setPushbutton('', box=self.ss_tab, click=self.ButtonClicked_35)
    self.sss_pushButton_12 = setPushbutton('', box=self.ss_tab, click=self.ButtonClicked_36)
    ...
    self.csb_pushButton_05 = setPushbutton('고저평균대비등락율', box=self.cs_tab, click=self.ButtonClicked_43)
    self.csb_pushButton_06 = setPushbutton('체결강도차이', box=self.cs_tab, click=self.ButtonClicked_44)
    ...
    self.csb_pushButton_14 = setPushbutton('', box=self.cs_tab, click=self.ButtonClicked_52)
    ...
    self.css_pushButton_05 = setPushbutton('보유시간기준', box=self.cs_tab, click=self.ButtonClicked_61)
    self.css_pushButton_06 = setPushbutton('손절라인설정', box=self.cs_tab, click=self.ButtonClicked_62)
    self.css_pushButton_07 = setPushbutton('익절라인설정', box=self.cs_tab, click=self.ButtonClicked_63)
    self.css_pushButton_08 = setPushbutton('체결강도차이', box=self.cs_tab, click=self.ButtonClicked_64)
    self.css_pushButton_09 = setPushbutton('호가총잔량비교', box=self.cs_tab, click=self.ButtonClicked_65)
    self.css_pushButton_10 = setPushbutton('고저평균대비등락율', box=self.cs_tab, click=self.ButtonClicked_66)
    self.css_pushButton_11 = setPushbutton('', box=self.cs_tab, click=self.ButtonClicked_67)
    self.css_pushButton_12 = setPushbutton('', box=self.cs_tab, click=self.ButtonClicked_68)
    ...
    self.sj_groupBox_05.setGeometry(5, 375, 1341, 120)
    self.sj_groupBox_06.setGeometry(5, 515, 1341, 120)
