...
class Window(QtWidgets.QMainWindow):
    ...
    def DrawChart(self, data):
        ...
        self.ctpg_02.clear()
        self.ctpg_03.clear()
        self.ctpg_01.plot(x=unix_ts, y=df['현재가'], pen=(200, 0, 0))
        self.ctpg_02.plot(x=unix_ts, y=df['체결강도'], pen=(0, 200, 0))
        self.ctpg_02.plot(x=unix_ts, y=df['체결강도평균'], pen=(0, 200, 200))
        self.ctpg_02.plot(x=unix_ts, y=df['최고체결강도'], pen=(200, 0, 0))
        self.ctpg_03.plot(x=unix_ts, y=df['초당거래대금'], pen=(200, 0, 0))
        self.ctpg_03.plot(x=unix_ts, y=df['초당거래대금평균'], pen=(0, 0, 200))
